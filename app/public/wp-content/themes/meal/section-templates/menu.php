      ...
      <div class="col-md-8">
        <ul class="nav site-tab-nav" id="pills-tab" role="tablist">
          ...
          if ($meal_feat_categories) :
            ...
            ?>
              <li class="nav-item">
                <a class="nav-link <?php if($meal_counter == 1) echo 'active'; ?>" id="pills-breakfast-tab" data-toggle="pill" href="#pills-<?php echo esc_attr($meal_feat_category->name); ?>" role="tab" aria-controls="pills-<?php echo esc_attr($meal_feat_category->name); ?>" aria-selected="<?php if($meal_counter == 1) echo 'true'; ?>"><?php echo esc_attr($meal_feat_category->name); ?></a>
              </li>
            <?php           
        ...
        <div class="tab-content" id="pills-tabContent">
          ...
          ?>" id="pills-<?php echo esc_attr($meal_feat_category->name); ?>" role="tabpanel" aria-labelledby="pills-<?php echo esc_attr($meal_feat_category->name); ?>-tab">
